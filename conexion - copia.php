...
<?php
	error_reporting(E_ALL);
 	class conexion{
  	...
  	function conecta(){
  		$val = false;
  		try{
  			$this->oConexion = new PDO("mysql:host=localhost;dbname=traductor","root","",  array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES 'UTF8'")); //USUARIO Y PASSWORD A DEFINIR DESDE ASISTENTE
  			$val = true;
  		}catch(Exception $e){
			throw $e;
		}
    ...
    //Condicion para conectarse a la base de datos y cachar los posibles errores
    /*try{
